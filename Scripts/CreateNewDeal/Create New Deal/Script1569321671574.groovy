...
//Call Login Page 
WebUI.comment('Creating New Deal which effects on"Sales Log"')
...
' Verify Create New Deals page or not'
if (WebUI.getUrl() == 'http://192.168.0.28:4205/saleslogs/new/parent') {
   ...
   // WebUI.click(findTestObject('CreateNewDeal/Page_Thor/div_NS'))
    ...
    //WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Thor Consultant Search'), findTestData('Create New Deal').getValue(
            //1, 1))
   ...
   // WebUI.click(findTestObject('CreateNewDeal/Page_Thor/Thor Consultant First'))
    ...
    WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Brand search'), findTestData('Create New Deal').getValue(
            2, 1))
...
if (WebUI.verifyElementClickable(findTestObject('Object Repository/CreateNewDeal/Page_Thor/Main/Assisting manager'), FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Candidate Name'), findTestData('Create New Deal').getValue(3, 
            1))
    ...
    WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Currency search'), findTestData('Create New Deal').getValue(
            13, 1))
    ...
    if (a.equals('Contractor')) {
        ...
        'Invoice Rate'
        WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Invoice rate'), findTestData('Create New Deal').getValue(
                5, 1))

        'Candidate Rate'
        WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Candidate rate'), findTestData('Create New Deal').getValue(
                6, 1))
        ...
        'Expenses'
        WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Expenses'), findTestData('Create New Deal').getValue(
                14, 1))

        'Expense Currency'
        WebUI.click(findTestObject('CreateNewDeal/Page_Thor/Main/Expence currency'), FailureHandling.STOP_ON_FAILURE)

        WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Expence search'), findTestData('Create New Deal').getValue(
                13, 1))
        ...
        'Start Date'
        WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Start Dtae'), pdate2)
        ...
        WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Billable salaary'), findTestData('Create New Deal').getValue(
                11, 1))

        'Thor Rate  '
        WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Thor Rate'), findTestData('Create New Deal').getValue(
                12, 1))
    ...
    if (errormessage.equalsIgnoreCase('Deal created successfully')) {
        ...
        if (WebUI.getUrl() == 'http://192.168.0.28:4205/saleslog') {
            ...
            'Search Created Deal'
            WebUI.setText(findTestObject('CreateNewDeal/Page_Thor/Main/Search'), findTestData('Create New Deal').getValue(
                    3, 1))
